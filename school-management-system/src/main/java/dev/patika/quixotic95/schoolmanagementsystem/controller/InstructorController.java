...
public class InstructorController {
    ...
    public ResponseEntity<?> savePermanentInstructor(@RequestBody PermanentInstructorDTO permanentInstructorDTO) {
    ...
    public ResponseEntity<?> saveVisitingResearcher(@RequestBody VisitingResearcherDTO visitingResearcherDTO) {
    ...
    public ResponseEntity<?> updatePermanentInstructor(@PathVariable long instructorId, @RequestBody PermanentInstructorDTO permanentInstructorDTO) {
    ...
    public ResponseEntity<?> updateVisitingResearcher(@PathVariable long instructorId, @RequestBody VisitingResearcherDTO visitingResearcherDTO) {
    ...
    public ResponseEntity<?> deletePermanentInstructor(@RequestBody PermanentInstructorDTO permanentInstructorDTO) {
    ...
    public ResponseEntity<?> deleteVisitingResearcher(@RequestBody VisitingResearcherDTO visitingResearcherDTO) {
